...
object Base extends Selectors {
  ...
  def timer(func: js.Function0[Boolean], delay: Int, interval: Int): Unit = ???
...
//  def data[A](values: js.Function2[js.Array[A], js.Number, js.Array[A]]): UpdateSelection = ???
...
trait Transition extends js.Object {
  ...
  def delay(valueFunction: js.Function2[js.Any, js.Number, js.Number]): Transition = ???
  def attr(name: js.String): js.String = ???
